...
prompt = f"Please search the web to research what Microsoft announced at this week's Build conference on Copilot agents. Summarize what you found in 200-300 words, email to {personal_email} and post on the Slack channel for my coworkers to see."

response = client.responses.create(
  model="gpt-4o-mini",
  input=prompt,
  instructions="You are a helpful assistant that can search the web and email results to a user.",
  tools=[{
            "type": "mcp",
            "server_label": "zapier",
